...
const Comedy = () => {
  ...
  useEffect(() => {
    const fetchComedyMovies = async () => {
      ...
      try {
        ...
        const filteredMovies = response.data.filter(movie => movie.genres.includes('Comedy'));
  ...
  const totalPages = Math.ceil(comedyMovies.length / MOVIES_PER_PAGE);
  const currentMovies = comedyMovies.slice((page - 1) * MOVIES_PER_PAGE, page * MOVIES_PER_PAGE);
